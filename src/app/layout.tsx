...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Aakash Gupta', url: 'https://github.com/aakash-gupta02' }],
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} bg-white text-gray-900 antialiased transition-colors duration-100 dark:bg-gray-900 dark:text-gray-100`}
      >
        <ThemeProvider>
          <Navbar />
          {children}
